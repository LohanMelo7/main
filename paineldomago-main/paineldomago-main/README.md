![logo](Link ta desativado por enquanto)
...
```bash
curl -o install.sh Link ta desativado por enquanto
bash install.sh
rm -r install.sh
```
...
pkg install python
pkg install git
git clone Link ta desativado por enquanto
...
```bash
curl -o update.sh Link ta desativado por enquanto
bash update.sh
rm -r update.sh
```
