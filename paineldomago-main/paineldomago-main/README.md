![logo](https://github.com/LohanMelo7/main/blob/main/paineldomago-main/paineldomago-main/gplogo.jpg)
<h1 align="center">PainelDoMago</h1>
...
```bash
curl -o install.sh https://github.com/LohanMelo7/main/blob/main/paineldomago-main/paineldomago-main/install.sh
bash install.sh
rm -r install.sh
```
...
pkg install python
pkg install git
git clone https://github.com/LohanMelo7/main/blob/main/paineldomago-main/paineldomago-main/install.sh
pip install requests
```
> Quando for utilizar o Painel:
```bash
cd
cd ghostpanel
python main.py
...
```bash
curl -o update.sh https://github.com/LohanMelo7/main/blob/main/paineldomago-main/paineldomago-main/update.sh
bash update.sh
rm -r update.sh
```
